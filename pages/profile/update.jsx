  ...
  return (
    <DashboardLayout className="flex justify-center">
      <div className="flex w-full lg:w-11/12 flex-col md:flex-row">
        ...
        <div className="bg-gray-50 px-6 pt-8 pb-2 rounded-lg w-full md:w-3/4 shadow-sm hover:shadow-md transition-all duration-300">
          <h3 className="font-semibold text-2xl mb-3 text-center md:text-left">Personal Information</h3>

          <form action="post" onSubmit={handleSubmit}>
            <div className="flex flex-col md:flex-row w-full md:mb-4">
              <label className="w-full text-gray-700 md:mr-1 mb-2 md:mb-0">
                First name
                <input
                  type="text"
              ...
              <label className="w-full text-gray-700 md:ml-1 mb-2 md:mb-0">
                Last name
                <input
                  type="text"
            ...
            <div className="flex w-full mb-4">
              <label className="w-full text-gray-700 mr-1 mb-2 md:mb-0">
                About yourself
                <input
                  type="text"
